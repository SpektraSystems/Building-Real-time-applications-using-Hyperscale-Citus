...
1.Open **Azure Data Studio** in the **Lab-VM** provided on the left side. Click on **Extension** icon, then in the search bar enter **PostgreSQL** and select **Install**. 

![](images/postext.png)

After this restart the Azure Data Studio.
